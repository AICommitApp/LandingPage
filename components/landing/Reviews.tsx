        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            ...
            <div className="flex gap-8">
              <div>
                <div className="text-3xl font-bold text-[#ded14f] tabular-nums">58%</div>
                <div className="text-xs text-gray-500 mt-1 uppercase tracking-wide">Renewal rate</div>
              </div>
              <div className="w-px bg-white/10" />
              <div>
                <div className="flex items-center gap-2">
                  <div className="text-3xl font-bold text-[#ded14f] tabular-nums">
                    <AnimatedCounter
                      value={20626}
                  ...
                  <span className="relative flex h-1.5 w-1.5 mb-0.5">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#ded14f] opacity-60" />
                    <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-[#ded14f]" />
                  </span>
                </div>
            ...
            >
              ...
              <div className="flex gap-0.5 mb-4">
                {Array.from({ length: 5 }).map((_, i) => (
                  <Star
                    key={i}
                    className={`w-4 h-4 ${i < review.stars ? 'text-[#ded14f] fill-[#ded14f]' : 'text-white/15'}`}
                  />
                ))}
              </div>
